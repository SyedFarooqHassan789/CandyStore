...
int Datastructure::hash(int id) const { //taking mod
        return (id%choclatestore.size());
}
//My functions starts from here

int Datastructure::findkey(string key)const{ // function to find index of hashtable
    int has = 5381;
    unsigned int i;
...
void Datastructure::resizevector(int size_of_vector){ //resizing vector size according to data
